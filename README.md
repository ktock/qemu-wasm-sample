...
QEMU's configure script supports `--cpu=wasm64` flag to compile QEMU with 64bit pointer support.
`--enable-wasm64-32bit-address-limit` flag enables the lowering support of Emscripten's [`-sMEMORY64=2` flag](https://emscripten.org/docs/tools_reference/settings_reference.html#memory64).
